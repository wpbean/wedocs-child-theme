...
<div class="wedocs-feedback-wrap wedocs-hide-print">
    ...
    <span class="vote-link-wrap">
        <a href="#" class="wedocs-tip positive btn-success btn-floating btn-large pulse" data-id="<?php the_ID(); ?>" data-type="positive" title="<?php echo esc_attr( $positive_title ); ?>">
            <?php _e( 'Yes', 'wedocs' ); ?>
        ...
        <a href="#" class="wedocs-tip negative btn-danger btn-floating btn-large pulse" data-id="<?php the_ID(); ?>" data-type="negative" title="<?php echo esc_attr( $negative_title ); ?>">
            <?php _e( 'No', 'wedocs' ); ?>
