		...
		<div class="navbar-header">
			...
			<?php 
				if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) {
                    ...
                    printf( '<a class="navbar-brand" href="%s" rel="home">%s</a>', esc_url( home_url( '/' ) ), esc_html( get_bloginfo( 'name' ) ) );
                }
			?>
		</div>
...
<?php if ( !is_page_template( 'templates/template-with-no-header.php' ) ): ?>
